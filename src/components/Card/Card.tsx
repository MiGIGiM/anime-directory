...
const Card: FC<{ anime: Anime; id: string | number }> = ({ anime, id }) => (
    <Link href={`/anime/${id}`}>
        <a className="w-56 h-96 bg-blue-300 m-auto relative rounded-md shadow-black shadow-lg">
            ...
            <Image src={anime.posterImage.original} layout="fill" className="z-0" priority />
        </a>
    </Link>
);
