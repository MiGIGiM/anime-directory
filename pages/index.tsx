...
const Home: NextPage = () => {
    ...
    return (
        <div className="bg-[#f2efe7] py-5 px-2 xl:flex xl:flex-row-reverse items-start justify-center xl:space-y-0 space-y-10 min-h-screen">
            ...
            >
                <Link href="/">
                    <a className="text-lg hover:opacity-30 text-gray-700 w-fit cursor-pointer md:text-2xl xl:mx-auto xl:text-3xl">
                        Anime Directory
                    </a>
                </Link>
                                ...
                                >
                                    <div className="inline-block w-full max-w-md p-6 my-8 overflow-hidden text-left align-middle transition-all transform bg-white shadow-xl rounded-2xl">
                                        ...
                                        <div className="mt-2">
                                            ...
                                            <button
                                                type="submit"
                                                className="bg-indigo-600 py-3 px-5 text-white font-semibold rounded-lg hover:shadow-lg"
                                            >
                                                <span>Search</span>
                                            </button>
                                        </div>
                ...
                <div className=" hidden xl:flex items-center p-2 space-x-2 h-fit w-fit mx-auto my-5 font-mono">
                    <form
                        className="flex bg-gray-200 p-4 w-72 space-x-4 rounded-lg"
                        onSubmit={(e) => {
                            e.preventDefault();
